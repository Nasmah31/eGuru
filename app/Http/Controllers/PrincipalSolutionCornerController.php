...
class PrincipalSolutionCornerController extends Controller
{
  /**
  ...
  public function index()
  {
      ...
      return view('principal/solutioncorner/index', compact('datas'));
  }
  ...
  public function create()
  {
      ...
      return view('principal/solutioncorner/create', compact('handles'));
  }
  ...
  public function store(Request $request)
  {
    ...
    if($check > 0){
      ...
      return redirect()->route('principalsc');
    }else{
  ...
  public function show($id)
  {
    ...
    return view('principal/solutioncorner/show', compact('data'));
  }
