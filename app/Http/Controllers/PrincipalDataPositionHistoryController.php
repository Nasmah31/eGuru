...
class PrincipalDataPositionHistoryController extends Controller
{
  /**
  ...
  public function create()
  {
      ...
      return view('principal/personaldata/datahistory/position/create', compact('positions'));
  }
  ...
  public function store(Request $request)
  {
      ...
      if($save){
        ...
        return redirect()->route('principalpdphcr');
      }
  }
