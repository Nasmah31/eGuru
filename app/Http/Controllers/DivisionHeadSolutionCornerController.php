...
class DivisionHeadSolutionCornerController extends Controller
{
    /**
    ...
    public function index()
    {
      ...
      return view('head_division/solutioncorner/index', compact('datas', 'finished'));
    }
     ...
     */
     public function show($id)
     {
       ...
       return view('head_division/solutioncorner/show', compact('data'));
     }
     ...
     */
     public function update(Request $request, $id)
     {
         ...
         return redirect()->route('divheadsc');
     }
