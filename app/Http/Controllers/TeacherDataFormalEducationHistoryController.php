...
class TeacherDataFormalEducationHistoryController extends Controller
{
    ...
    {
        return view('teacher/personaldata/datahistory/formaleducation/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($save){
          ...
          return redirect()->route('teacherpdfehcr');
        }
    }
