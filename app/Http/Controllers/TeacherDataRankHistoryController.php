...
class TeacherDataRankHistoryController extends Controller
{
  /**
  ...
  public function create()
  {
      ...
      return view('teacher/personaldata/datahistory/rank/create', compact('ranks'));
  }
  ...
  public function store(Request $request)
  {
      ...
      if($save){
        ...
        return redirect()->route('teacherpdrhcr');
      }
  }
