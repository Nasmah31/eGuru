...
class PrincipalDataAppreciationHistoryController extends Controller
{
  /**
  ...
  {
      return view('principal/personaldata/datahistory/appreciation/create');
  }
  ...
  public function store(Request $request)
  {
      ...
      if($save){
        ...
        return redirect()->route('principalpdahcr');
      }
  }
