...
class PrincipalMyLeavePermissionController extends Controller
{
  /**
  ...
  */
  public function create()
  {
    ...
    return view('principal/leavepermission/myleavepermission/create', compact('leavetypes'));
  }
  ...
  */
  public function store(Request $request)
  {
    ...
    if($save){
      ...
      return redirect()->route('principallpcreate');
    }
  }
  ...
  */
  public function show($id)
  {
    ...
    return view('principal/leavepermission/myleavepermission/show', compact('data'));
  }
  ...
  */
  public function pdf($id)
  {
    ...
    return view('principal/leavepermission/myleavepermission/pdf', compact('datas', 'bossdata', 'officialqrcode', 'pdatas', 'credential', 'detail', 'get_decree_number', 'decree_head'));
