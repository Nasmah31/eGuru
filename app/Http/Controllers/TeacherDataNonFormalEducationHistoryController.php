...
class TeacherDataNonFormalEducationHistoryController extends Controller
{
  /**
  ...
  {
      return view('teacher/personaldata/datahistory/nonformaleducation/create');
  }
  ...
  public function store(Request $request)
  {
      ...
      if($save){
        ...
        return redirect()->route('teacherpdnfehcr');
      }
  }
