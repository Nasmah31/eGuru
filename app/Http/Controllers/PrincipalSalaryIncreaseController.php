...
class PrincipalSalaryIncreaseController extends Controller
{
  /**
  ...
  */
  public function index()
  {
    ...
    return view('principal/salaryincrease/index', compact('datas'));
  }
  ...
  */
  ...
  {
    return view('principal/salaryincrease/create');
  }
  ...
  */
  public function store(Request $request)
  {
    ...
    if($check > 0){
      ...
      return redirect()->route('principalsi');
    }else{
  ...
  */
  public function show($id)
  {
    ...
    return view('principal/salaryincrease/show', compact('data', 'files'));
  }
  ...
  */
  public function upload($id, $siid)
  {
    ...
    return view('principal/salaryincrease/upload', compact('data', 'siid'));
  }
  ...
  public function uploadfile(Request $request, $id, $siid)
  {
    ...
    if($check->file != NULL){
      ...
      return redirect()->route('principalsishow', $siid);
    }else{
  ...
  public function pdf($id)
  {
    ...
    return view('principal/salaryincrease/pdf', compact('data', 'decree_head', 'get_decree_number', 'next_tmt', 'officialqrcode'));
  }
