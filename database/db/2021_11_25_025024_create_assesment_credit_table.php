...
class CreateAssesmentCreditTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('assesment_credit', function (Blueprint $table) {
        ...
        DB::statement('ALTER TABLE assesment_credit ALTER COLUMN id SET DEFAULT uuid_generate_v4();');
    }
    ...
    {
        Schema::dropIfExists('assesment_credit');
    }
}
