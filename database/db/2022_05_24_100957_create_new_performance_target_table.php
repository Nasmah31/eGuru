...
class CreateNewPerformanceTargetTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('new_performance_target', function (Blueprint $table) {
        ...
        DB::statement('ALTER TABLE new_performance_target ALTER COLUMN id SET DEFAULT uuid_generate_v4();');
    }
    ...
    {
        Schema::dropIfExists('new_performance_target');
    }
}
