...
<div class="container mx-auto px-4 sm:px-8">
  <div class="py-8">
    <div>
      <h2 class="text-2xl text-center leading-tight">Daftar Pengajuan Pojok Solusi</h2>
    </div>
        ...
        <table class="min-w-full leading-normal">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                <p class="text-gray-900 whitespace-no-wrap">
                  {{$data->confide_date->isoFormat('DD MMMM Y')}} - {{$data->queue_number}}
                </p>
              </td>
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                <p class="text-gray-900 whitespace-no-wrap">
                  {{$data->handle->personalData->name}} - {{$data->handle->personalData->teacher_type}}
                </p>
              </td>
              ...
              @endif
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                <a href="/administrator/solutioncorner/destroy/{{$data->id}}" class="text-red-600 hover:text-red-400 ml-2">
