...
<div class="container mx-auto px-4 sm:px-8">
  <div class="py-8">
    <div>
      <h2 class="text-2xl text-center leading-tight">List Pengajuan Cuti</h2>
    </div>
        ...
        <table class="min-w-full leading-normal">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                <p class="text-gray-900 whitespace-no-wrap">
                  {{$data->start_date->isoFormat('DD')}} - {{$data->end_date->isoFormat('DD MMMM YYYY')}}
                </p>
              </td>
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                <p class="text-gray-900 whitespace-no-wrap">
                  {{$data->leaveType->name}} - {{$data->leave_duration}} Hari
                </p>
              </td>
              ...
              @endif
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                <a href="/administrator/leavepermission/destroy/{{$data->id}}" class="text-red-600 hover:text-red-400 ml-2">
