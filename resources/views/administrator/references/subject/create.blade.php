...
<div class="container px-4 sm:px-8">
  <div class="py-8">
    ...
    <div class="p-10 md:w-3/4 lg:w-1/2 mx-auto">
      ...
      @endforeach
      @endif
      <form action="/administrator/reference/subject/store" method="POST" class="w-full max-w-lg">
        @csrf
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
          <div class="w-full px-3">
            ...
            <select name="subject_type" id="subject_type" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
          <div class="w-full px-3">
            ...
            <select name="lesson_level" id="lesson_level" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
              <option value="">Pilih Level Mata Pelajaran</option>
        ...
        <div class="md:flex md:items-center">
          <div class="md:w-1/3">
            ...
            <button onclick="window.location='{{ url ('/administrator/reference/subject') }}'" class="shadow bg-red-600 hover:bg-red-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
              Cancel
            </button>
          </div>
