        ...
        <table class="w-full">
          <tbody class="bg-white">
            <tr class="text-gray-700 text-center">
              ...
              <td class="px-4 py-3 text-ms border">{{$data->refWorkBehavior->name}}</td>
            </tr>
          </tbody>
        </table>
      </div>
      <div class="md:flex md:justify-center md:space-x-8 md:px-14 bg-white mt-10">
        <form action="{{ route('principalptwbscore', array($data->id, $idpt))}}" method="POST" class="w-full max-w-lg mt-10">
          ...
          <div class="flex flex-col -mx-3 mb-6">
            <div class="w-full px-3">
              ...
              <input name="score" id="score"  type="number" step=".001" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" required>
            </div>
          </div>
