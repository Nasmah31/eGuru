...
<div class="container mx-auto px-6 sm:px-12 flex flex-col-reverse sm:flex-row relative">
  ...
  <div class="sm:w-5/12 xl:w-4/12 flex flex-col items-start sm:items-end sm:text-right ml-auto mt-8 sm:mt-0 relative z-10 xl:pt-20 mb-16 sm:mb-0">
    <h1 class="text-4xl lg:text-5xl text-blue-900 leading-none mb-4 font-black">SELAMAT DATANG DI APLIKASI E-GURU {{auth()->user()->personalData->name}}</h1>
    <p class="lg:text-lg mb-4 sm:mb-12 text-blue-900 capitalize">
      aplikasi e-Guru adalah salah satu aplikasi yang berfungsi sebagai
