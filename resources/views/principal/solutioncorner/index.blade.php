    ...
    <div class="w-48">
      <div class="my-2 flex sm:flex-row flex-col">
        <div class="block relative">
          <a class="text-white" href="/principal/solutioncorner/create">
        ...
        <table class="w-full">
          ...
          <tbody class="bg-white">
            ...
            <tr class="text-gray-700 text-center">
              ...
              @endif
              <td class="px-4 py-3 text-sm border">
                <a href="{{ url ('/principal/solutioncorner/show', array("$data->id")) }}" class="text-green-600 hover:text-green-400 mr-2">
