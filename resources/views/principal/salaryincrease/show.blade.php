...
<div class="min-h-screen bg-gray-200 py-3">
  <a href="/principal/salaryincrease">
        ...
        <table class="w-full mb-8">
          ...
          <tbody class="bg-white">
            ...
            <tr class="text-gray-700 text-center">
              ...
              <td class="px-4 py-3 text-sm border">
                @if($file->file == NULL)
                <a href="{{ url ('/principal/salaryincrease/upload', array("$file->id", "$data->id")) }}" class="text-green-600 hover:text-green-400 mr-2">
          ...
          <div class="flex items-center justify-center mt-10">
            <div class="w-full max-w-md mr-4">
              <form action="{{ route('principalsilock', $data->id)}}" method="POST" class="bg-white shadow-lg rounded px-12 pt-6 pb-8 mb-4 border-2 border-red-500">
                @csrf
