  ...
  <div class="px-5 mx-auto max-w-7x1">
    ...
    <div class="my-2 flex sm:flex-row flex-col">
      <div class="block relative">
        <a class="text-white" href="/teacher/creditscore/create">
        ...
        <table class="min-w-full leading-normal">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                <a href="/teacher/creditscore/show/{{$data->id}}" class="text-green-600 hover:text-green-400 ml-2">
                  <i class="material-icons-round text-base">visibility</i>
                </a>
                @if($data->is_ready == FALSE)
                <a href="/teacher/creditscore/destroy/{{$data->id}}" class="text-red-600 hover:text-red-400 ml-2">
