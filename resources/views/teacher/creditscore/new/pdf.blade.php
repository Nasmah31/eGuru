...
<div class="box is-box">
  ...
  <h1 align="center" class="titlef is-5"><b>PERIODE TAHUN {{$get_assesment_credit_data->newPerformanceTarget->assessment_year}}</b></h1>
<div class="columns">
  <div class="column">
    <div class="columns">
    <div class="column">
...
<tr>
  <td>{{$num++}}</td>
  <td>{{$get_rejected_data->newPerformanceTargetScore->refActivityCreditScore->grain_item}} {{$get_rejected_data->newPerformanceTargetScore->refActivityCreditScore->sub_grain_item}}</td>
  <td></td>
  <td>{{$get_rejected_data->id}}</td>
  <td>{{$get_rejected_data->reason}}</td>
  <td>{{$get_rejected_data->suggestion}}</td>
  <td>{{$get_rejected_data->newPerformanceTargetScore->realization_credit_score}}</td>
</tr>
@endforeach
</tbody>
</table>
