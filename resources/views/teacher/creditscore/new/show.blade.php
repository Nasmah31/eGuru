  ...
  <div class="px-5 mx-auto max-w-7x1">
          ...
          <tbody class="bg-white">
            ...
            <tr class="text-gray-700 text-center">
              ...
              <td class="px-4 py-3 text-ms border">
                <a class="text-blue-500 underline" href="{{ asset('storage/newcreditscore/' . $assesment->file) }}">
                  {{$assesment->file}}
                </a>
              </td>
            </tr>
            ...
            <tr class="text-gray-700 text-center">
              <td class="px-4 py-3 text-ms border font-semibold">File PAK {{$assesment->newPerformanceTarget->assessment_year}}</td>
              <td class="px-4 py-3 text-ms border">
                <a href="/teacher/newcreditscore/pdf/{{$assesment->id}}">
    ...
    <div class="my-2 flex sm:flex-row flex-col">
      <div class="block relative ">
        <a class="text-white" href="/teacher/newcreditscore/create/oldactivity/{{$assesment->id}}">
    ...
    <div class="mx-4 sm:mx-8 px-4 sm:px-8 overflow-x-auto ">
        ...
        <table class="min-w-full leading-normal">
          ...
          <tbody>
            ...
            <tr>
              ...
              @if($assesment->is_ready != TRUE)
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                <a href="/teacher/newcreditscore/edit/{{$data->id}}/{{$assesment->id}}" class="text-green-600 hover:text-green-400 ml-2">
      ...
      <div class="flex items-center justify-center mt-10">
        <div class="w-full max-w-md mr-4">
          <form action="{{ route('teacherncslock', array("$assesment->id"))}}" method="POST" class="bg-white shadow-lg rounded px-12 pt-6 pb-8 mb-4 border-2 border-red-500">
            @csrf
