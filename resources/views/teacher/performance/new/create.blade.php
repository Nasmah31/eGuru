...
<div class="min-h-screen bg-white py-14">
  <div class="px-5 mx-auto max-w-7x1">
    ...
    <div class="md:flex md:justify-center md:space-x-8 md:px-14">
      <form action="/teacher/newperformance/store" method="POST" class="w-full max-w-lg" enctype="multipart/form-data">
        @csrf
        @if(session('errors'))
        ...
        <div class="md:flex md:items-center">
          <div class="md:w-1/3">
            ...
            <button onclick="window.location='{{ url ('/teacher/newperformance') }}'" class="shadow bg-red-600 hover:bg-red-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
              Cancel
            </button>
          </div>
