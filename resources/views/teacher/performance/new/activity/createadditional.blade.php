      ...
      <form action="{{ route('teachernptastoreadditional', $id)}}" method="POST" class="w-full max-w-lg">
        ...
        <div class="flex flex-col -mx-3 mb-6">
          <div class="w-full px-3">
            ...
            <input name="target_time" id="target_time" placeholder="Masukkan Target Waktu" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="number" min="1" max="12" required>
          </div>
        </div>
