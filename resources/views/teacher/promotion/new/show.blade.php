          ...
          <tbody class="bg-white">
            ...
            <tr class="text-gray-700 text-center">
              ...
              <td class="px-4 py-3 text-sm border">
                @if($file->file == NULL)
                <a href="{{ url ('/teacher/newpromotion/upload', array("$file->id", "$data->id")) }}" class="text-green-600 hover:text-green-400 mr-2">
        ...
        <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                  <a href="/teacher/newpromotion/score/edit/{{$score->id}}/{{$data->id}}" class="text-green-600 hover:text-green-400 ml-2">
                    <i class="material-icons-round text-base">visibility</i>
                  </a>
                </td>
                @else
                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                  <a href="/teacher/newpromotion/score/destroy/{{$score->id}}" class="text-red-600 hover:text-red-400 ml-2">
          ...
          <div class="flex items-center justify-center mt-10">
            <div class="w-full max-w-md mr-4">
              <form action="{{ route('teachernpmlock', $data->id)}}" method="POST" class="bg-white shadow-lg rounded px-12 pt-6 pb-8 mb-4 border-2 border-red-500">
                @csrf
