        ...
        <table class="min-w-full leading-normal">
          ...
          <tbody>
            ...
            <tr>
              ...
              @if($data->is_finish == TRUE && $data->is_rejected == FALSE)
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                <span class="inline-block rounded-full text-white bg-green-500 px-2 py-1 text-xs font-bold mr-3">Pengajuan Diterima</span>
              </td>
              ...
              @endif
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                <a href="/divisionhead/promotion/show/{{$data->id}}" class="text-green-600 hover:text-green-400 ml-2">
