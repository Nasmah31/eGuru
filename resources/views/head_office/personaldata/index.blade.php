...
<div class="min-h-screen bg-blue-200 py-3">
  ...
  <div class="px-5 mx-auto max-w-7x1">
    <h1 class="mb-12 text-center text-4xl text-black font-bold">Data Bawahan</h1>
    ...
    <div class="w-full overflow-x-auto">
      <table class="w-full">
        ...
        <tbody class="bg-white">
          ...
          @if($user_id = auth()->user()->personal_data_id != $data->id)
          <tr class="text-gray-700 text-center">
            ...
            <td class="px-4 py-3 text-ms border">
              <a href="{{ url ('/officehead/personaldata/show', array("$data->id")) }}" class="text-green-600 hover:text-green-400 mr-2">
